...
**Response** (embedding endpoint down):

```json
{
  "status": "degraded",
  "backend": "qdrant",
  "total_memories": 12007,
  "vector_health": { "status": "green", "backend": "qdrant", "details": { "points_count": 12007 } },
  "graph_health": { "status": "healthy", "node_count": 18110, "edge_count": 137550 },
  "embedding_health": { "status": "unhealthy", "error": "Embedding generation failed" }
}
```
